...
var config = {
  ...
  physics: {
    ...
    arcade: {
      ...
      debug: true, // Disable the physics debugging
    },
  },
  scene: {
...
function preload() {
  this.load.image("sky", "./assets/firstGame/sky.png"); // Load background image
  this.load.image("ground", "./assets/firstGame/platform.png"); // Load ground platform image
  this.load.image("star", "./assets/firstGame/star.png"); // Load star image
  this.load.image("bomb", "./assets/firstGame/bomb.png"); // Load bomb image
  this.load.spritesheet("dude", "./assets/firstGame/dude.png", {
    frameWidth: 32,
    frameHeight: 48,
...
function create() {
  ...
  player.setCollideWorldBounds(false); // Prevent the player from going out of bounds
